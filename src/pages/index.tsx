  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="HR Information System - Streamlining Your Business with Comprehensive Employee Data Management, Vacation Tracking, and Payroll Solutions" />
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Streamlining Your Business with Comprehensive Employee Data Management, Vacation Tracking, and Payroll Solutions`}
            </Text>
            <Box
